...
handler.command = /^(mxmxk)$/i

export default handler

async function addExif(buffer, packname, author, categories = [''], extra = {}) {
	const img = new Image()
	const json = { 'sticker-pack-id': 'Re7Pntx masbro', 'sticker-pack-name': packname, 'sticker-pack-publisher': author, 'emojis': ['⚙️', '😭', '😂', '😘'], 'is-avatar-sticker': 1, 'apa-mau-colong': 'yaha hayukkk', ...extra }
