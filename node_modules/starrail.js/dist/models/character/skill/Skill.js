...
class Skill {
    constructor(id, client, skillIndexToUse = 0) {
        ...
        this.skillTypeText = new TextAssets_1.TextAssets(json.getAsNumber("SkillTypeDesc", "Hash"), this.client);
        this.effectType = json.getAsString("SkillEffect");
        this.effectTypeText = new TextAssets_1.TextAssets(json.getAsNumber("SkillTag", "Hash"), this.client);
...
class LeveledSkill extends Skill {
    constructor(data, level, client) {
        ...
        this.simpleDescription = new DynamicTextAssets_1.DynamicTextAssets(json.getAsNumber("SimpleSkillDesc", "Hash"), { paramList: this.simpleParamList }, this.client);
    }
}
